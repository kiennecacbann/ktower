...
const UtilContainerByCategoriesId = ({ data }) => {
  return (
    <div className='pt-[50px]'>
      <div className='items-center justify-center flex flex-col'>
        ...
        <h2 className='text-[46px] font-extrabold'>ALL UTILS BY CATEGORIES</h2>
      </div>
          ...
          <Link to={`/util/${item._id}`} className='block max-w-[450px] w-full max-h-[470px] h-full cursor-pointer'
            ...
            <div>
              <div className='pb-5 pt-2'>
                ...
                <p className='text-[20px] leading-7 line-clamp-2 font-bold text-black'>{item?.title}</p>
...
export default UtilContainerByCategoriesId