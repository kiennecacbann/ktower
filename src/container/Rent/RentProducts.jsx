  ...
  return (
    <div className='bg-white'>
      <div className='flex justify-between items-center px-[100px]'>
        <Link to='/home'>
          <button
            className=' rounded-full hover:border-2 hover:border-black mt-10 w-full flex justify-between items-center lg:w-auto lg:static lg:block lg:justify-start cursor-pointer '>
            <a className=''><img src={images.logo} alt='logo img' className=' w-14 h-14 rounded-full' /></a>
          </button>
        </Link>
        <div className='flex'>
          <input placeholder='Search...'
                 className='w-[500px] h-12 p-2 bg-[#d5d1ce] placeholder:text-black relative rounded border-none outline-none' />
                ...
                <div className='py-3 px-2 max-h-[630px] overflow-y-scroll'>
                  ...
                  <div className='justify-center items-center flex flex-col w-full'>
                    <Link to='/orderhistory'>
                      <button
                        class='font-bold text-[20px] w-full p-3 cursor-pointer block hover:bg-gray-200 dark:hover:bg-gray-100 dark:hover:text-white'>
                        Order #13432
                      </button>
                    </Link>
                  </div>
      ...
      <div className='px-[100px] flex'>
        ...
        <div className='pl-20 pt-0'>
          <div className='text-black h-5 w-16 mb-10  '>
            <select
              className='cursor-pointer flex justify-between items-center p-1 border-2 border-[black] rounded-lg outline-none font-bold'>Sort<AiFillCaretDown />
              ...
              <div className='relative flex flex-wrap justify-between text-black font-bold'>
                <div className='max-w-[240px] max-h-[500px] mb-10 text-center'>
                  ...
                  <div className='justify-between flex px-1 text-[15px] mt-5'>
                    <button type='button'
                            class='w-full text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 '>RENT
                    </button>
                  </div>
                </div>
                <div className='max-w-[240px] max-h-[500px] mb-10 text-center'>
