    ...
    return (
        <div className='h-full'>
            <div class="bg-indigo-900 relative overflow-hidden h-screen">
                ...
                <div class="container mx-auto px-6 md:px-12 relative z-10 flex items-center py-20 xl:py-30">
                    <div class="w-full font-mono flex flex-col items-center relative z-10">
                        <h1 class="font-extrabold text-5xl text-center text-white leading-tight mt-2">
                            Oops!
                        </h1>
                        <h1 class="font-extrabold text-5xl text-center text-white leading-tight mt-2">
